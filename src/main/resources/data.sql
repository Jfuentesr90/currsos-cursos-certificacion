...
INSERT INTO curso (id,nombre,imagen,fecinicio,fectermino,cupos,descripcion) VALUES (0,'prueba','https://www.gstatic.com/webp/gallery/1.webp','2022-06-02','2022-06-02',0,'desc1');
INSERT INTO estudiante (rut, password,enabled, nombre, telefono,direccion,email,id_region,id_curso,edad) values ('admin','$2a$12$C73lB8gj7l4RZolfU/21bOkpfpi/6HjA/ZOkO0dr/lFTDFiZBiNfu',1,'jorge', '985611756','laslilas','fuentes.jorge26@gmail.com',6,0,18);
